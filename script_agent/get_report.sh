...
report_sql=" select pk_ds_day||'|'||pk_ds_stat_type||'|'||ds_num from com_day_stat where pk_ds_stat_type in ('13001','13002','13003','13017','13009','13087','13018','13088','13007','13008')
