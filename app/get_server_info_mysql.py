...
all_launch_list_sql = """select site_id,site_name,site_ops,site_ops_number from allsite_info order by site_id"""
all_monitor_siteid_sql = """select site_id from site_info order by site_id"""
launch_site_name_sql = """select site_id,site_name from allsite_info where site_id='{site_id}'"""
